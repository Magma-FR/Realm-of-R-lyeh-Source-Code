    ...
    public class GlobalItemList : GlobalItem
    {
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            if (item.type == ItemID.TitanPotion)
            {
                ...
                if (line != null)
                {
                    line.Text = "10% increased weapon speed and knockback";
        ...
        public override void SetDefaults(Item item)
        {
            ...
            if (item.type == ItemID.Flamarang) item.useTime = 10;
...

        {
            ...
            amarok.AddIngredient(ItemID.IceBlock, 30);
            amarok.AddIngredient(ItemID.SnowBlock, 30);
            ...
            Recipe shroomites = Recipe.Create(ItemID.ShroomiteBar);
            shroomites.AddIngredient(Mod,"ShroomiteShattershards", 5);
            shroomites.AddTile(TileID.Autohammer);
            shroomites.Register();
        }
