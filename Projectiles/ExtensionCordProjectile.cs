...
namespace RealmOne.Projectiles
{
    public class ExtensionCordProjectile : ModProjectile
    {
        ...
        public override string Texture => "RealmOne/Projectiles/ExtensionCordProjectile";
        ...
        private bool Charge(Player owner)
        {
            ...
            if (!owner.channel || ChargeTime >= 140)
            {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.damage = (int)(damage * 0.3f); // Multihit penalty. Decrease the damage the more enemies the whip hits.
