...
namespace RealmOne.Items
{
    public class ExtensionCord : ModItem
    {
        ...
        public override string Texture => "RealmOne/Items/ExtensionCord";
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("'An unstable and live wire, containing many volts'"
                +"\nHold to charge the whip, fully charging the whip increases the whip by 50% and inflicts Electricity and it does more damage on impact");
