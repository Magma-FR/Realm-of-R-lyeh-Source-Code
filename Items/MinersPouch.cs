...
namespace RealmOne.Items
{
    public class MinersPouch : ModItem
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.GizmoScrap>(), 4, 3, 4));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<Items.ScavengerSteel>(), 4, 3, 4));
