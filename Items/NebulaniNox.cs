...
namespace RealmOne.Items
{
    public class NebulaniNox: ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            line = new TooltipLine(Mod, "NebulaniNox", "'Using evil to fight evil!!'")
            {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int d = 0; d < 10; d++)
            {
                Dust.NewDust(player.position, player.width, player.height, DustID.UnusedWhiteBluePurple, 0f, 0f, 150, default(Color), 2f);
                Dust.NewDust(player.position, player.width, player.height, DustID.Shadowflame, 0f, 0f, 150, default(Color), 2f);
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Dust d = Dust.NewDustPerfect(Main.LocalPlayer.Center, DustID.ShadowbeamStaff, speed * 10, Scale: 2.5f);; ;
        ...
        public override void AddRecipes()
        {
            ...
            .AddRecipeGroup("Wood", 10)
             .AddIngredient(Mod, "BrassIngot", 8)
